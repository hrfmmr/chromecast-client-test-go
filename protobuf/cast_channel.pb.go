...
type CastMessage struct {
	ProtocolVersion *CastMessage_ProtocolVersion `protobuf:"varint,1,req,name=protocol_version,json=protocolVersion,enum=CastMessage_ProtocolVersion" json:"protocol_version,omitempty"`
	...
	PayloadType *CastMessage_PayloadType `protobuf:"varint,5,req,name=payload_type,json=payloadType,enum=CastMessage_PayloadType" json:"payload_type,omitempty"`
...
type AuthChallenge struct {
	SignatureAlgorithm   *SignatureAlgorithm `protobuf:"varint,1,opt,name=signature_algorithm,json=signatureAlgorithm,enum=SignatureAlgorithm,def=1" json:"signature_algorithm,omitempty"`
	SenderNonce          []byte              `protobuf:"bytes,2,opt,name=sender_nonce,json=senderNonce" json:"sender_nonce,omitempty"`
	HashAlgorithm        *HashAlgorithm      `protobuf:"varint,3,opt,name=hash_algorithm,json=hashAlgorithm,enum=HashAlgorithm,def=0" json:"hash_algorithm,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
type AuthResponse struct {
	...
	SignatureAlgorithm      *SignatureAlgorithm `protobuf:"varint,4,opt,name=signature_algorithm,json=signatureAlgorithm,enum=SignatureAlgorithm,def=1" json:"signature_algorithm,omitempty"`
	SenderNonce             []byte              `protobuf:"bytes,5,opt,name=sender_nonce,json=senderNonce" json:"sender_nonce,omitempty"`
	HashAlgorithm           *HashAlgorithm      `protobuf:"varint,6,opt,name=hash_algorithm,json=hashAlgorithm,enum=HashAlgorithm,def=0" json:"hash_algorithm,omitempty"`
...
type AuthError struct {
	ErrorType            *AuthError_ErrorType `protobuf:"varint,1,req,name=error_type,json=errorType,enum=AuthError_ErrorType" json:"error_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func init() {
	proto.RegisterEnum("SignatureAlgorithm", SignatureAlgorithm_name, SignatureAlgorithm_value)
	proto.RegisterEnum("HashAlgorithm", HashAlgorithm_name, HashAlgorithm_value)
	proto.RegisterEnum("CastMessage_ProtocolVersion", CastMessage_ProtocolVersion_name, CastMessage_ProtocolVersion_value)
	proto.RegisterEnum("CastMessage_PayloadType", CastMessage_PayloadType_name, CastMessage_PayloadType_value)
	proto.RegisterEnum("AuthError_ErrorType", AuthError_ErrorType_name, AuthError_ErrorType_value)
	proto.RegisterType((*CastMessage)(nil), "CastMessage")
	proto.RegisterType((*AuthChallenge)(nil), "AuthChallenge")
	proto.RegisterType((*AuthResponse)(nil), "AuthResponse")
	proto.RegisterType((*AuthError)(nil), "AuthError")
	proto.RegisterType((*DeviceAuthMessage)(nil), "DeviceAuthMessage")
}

func init() {
	proto.RegisterFile("cast_channel.proto", fileDescriptor_a9ec15de9f2e74a1)
}

var fileDescriptor_a9ec15de9f2e74a1 = []byte{
	// 719 bytes of a gzipped FileDescriptorProto
	,
}
